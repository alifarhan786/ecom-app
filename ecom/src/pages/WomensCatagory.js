...
const MensCatagory = () => {
    ...
    useEffect(()=>{
     ...
     const MenProduct = products.filter((product)=>  product.category=="women")
    ...
    return (
        <div className='py-6 mx-2'>
            <div className='flex flex-col mx-2 items-center gap-4'>
                <h1 className={`text-2xl border-r ${isToggleOn?'bg-white text-black':'bg-black text-white'} py-2 w-80 text-center fade-in`}>Womens Category</h1>
