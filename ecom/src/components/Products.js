    ...
    return (
        <div className='py-6 mx-2'>
            <div className='flex flex-col mx-2 items-center gap-4'>
                <h1 className={`text-2xl border-r ${isToggleOn?'bg-white text-black':'bg-black text-white'} py-2 w-80 text-center fade-in`}>Welcome to ChicLoom!</h1>
                <span className='w-20 h-[3px] bg-gray-500'></span>
               <p className={` ${isToggleOn ? 'text-cyan-200' : 'text-black'}  text-center text-base slide-in-left`}>Discover your unique style and elevate your wardrobe with ChicLoom – where fashion meets passion.<br/> Happy shopping!</p>
            </div>
